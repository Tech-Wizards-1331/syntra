...
import { Github, Lock, Mail, User, Loader2, ArrowRight, CheckCircle2 } from "lucide-react";
        ...
        <div className="w-full max-w-md">
          ...
          <div className="p-8 rounded-2xl bg-slate-900/50 border border-slate-800/80 hover:border-teal-500/20 hover:bg-slate-900/60 transition duration-300 shadow-glass flex flex-col gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-slate-400">Join Syntra to participate in the hackathon</p>
            </div>
            ...
            <form action={formAction} className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <label htmlFor="fullName" className="text-[10px] text-slate-400 font-medium tracking-widest uppercase flex items-center gap-1">
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="confirmPassword" className="text-[10px] text-slate-400 font-medium tracking-widest uppercase flex items-center gap-1">
            ...
            <div className="text-center mt-2">
              <p className="text-xs text-slate-400">
                ...
                <Link href="/login" className="text-teal-400 hover:text-teal-300 transition duration-300 font-medium">
                  Sign In
                </Link>
              </p>
            </div>
